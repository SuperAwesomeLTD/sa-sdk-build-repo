...
cp kws_ios_build/KidsWebServicesSDK.lib.zip package/kws_ios/$sdk_version_kws_ios/KidsWebServicesSSDK-$sdk_version_kws_ios.iOS.lib.zip
cp kws_ios_build/KidsWebServicesSDK.framework.zip package/kws_ios/$sdk_version_kws_ios/KidsWebServicesSDK-$sdk_version_kws_ios.iOS.framework.zip
