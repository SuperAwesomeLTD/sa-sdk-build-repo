...
echo "<string>tv.superawesome.$framework_project</string>" >> $plist
...
/usr/bin/xcodebuild -target $framework_project ONLY_ACTIVE_ARCH=NO -configuration Release -sdk iphoneos DEVELOPMENT_TEAM= CODE_SIGN_IDENTITY=
