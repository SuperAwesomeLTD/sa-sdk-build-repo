...
mkdir $kws_ios_build_framework_src
...
cd
cp -r $kws_ios_build_framework_src/Release-iphoneos/$framework_project.framework $kws_ios_build/
lipo -create -output "$kws_ios_build/$framework_project.framework/$framework_project" "$kws_ios_build_framework_src/Release-iphoneos/$framework_project.framework/$framework_project" "$kws_ios_build_framework_src/Release-iphonesimulator/$framework_project.framework/$framework_project"

# final copy
find $kws_ios_build_framework_src -iname '*.h' -exec cp \{\} $kws_ios_build/$framework_project.framework/Headers/ \;
