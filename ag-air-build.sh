...
# set source and repo
source=sa-adobeair-agegate-sdk
...
cp sagair/build/outputs/aar/sagair-release.aar ../$build/android/sagair.zip
...
unzip sagair.zip -d sagair && rm sagair.zip
cp sagair/classes.jar sagair.jar && rm -rf sagair
...
echo "<packagedDependency>$destination.jar</packagedDependency>" >> $androidPlatformFile
echo "</packagedDependencies>" >> $androidPlatformFile
...
echo "<id>tv.superawesome.plugins.agegate.air</id>" >> $extensionFile
...
echo "<nativeLibrary>sagair.jar</nativeLibrary>" >> $extensionFile
echo "<initializer>tv.superawesome.plugins.agegate.air.SAgAIR</initializer>" >> $extensionFile
echo "</applicationDeployment>" >> $extensionFile
...
echo "<initializer>SAgExtensionInitializer</initializer>" >> $extensionFile
echo "</applicationDeployment>" >> $extensionFile
echo "</platform>" >> $extensionFile
# default platform
